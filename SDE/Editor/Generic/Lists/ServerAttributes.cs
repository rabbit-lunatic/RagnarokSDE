...
namespace SDE.Editor.Generic.Lists
{
    public sealed class ServerItemAttributes : DbAttribute
    {
        ...
        public static readonly DbAttribute Upper = new ServerItemAttributes(new DbAttribute("Upper", typeof(PreviewUpperFlagProperty<int>), "127")) { DataConverter = ValueConverters.GetHexToIntSetInt, Description = "Restricts the usage of the item based for a specific class group." };
        ...
        public static readonly DbAttribute Gradable = new ServerItemAttributes(new DbAttribute("Grade", typeof(bool), "", "Gradable")) { DataConverter = ValueConverters.GetBooleanSetGradableString, Description = "Defines wheter or not the equipment can be graded (the value is ignored for other item types)." };
    ...
    public sealed class ServerMobAttributes : DbAttribute
    {
        ...
        public static readonly DbAttribute Resistance = new ServerMobAttributes(new DbAttribute("Resistance", typeof(string), "0", "Resistance")) { DataConverter = ValueConverters.GetSetZeroString, Description = "The resistance of the mob." };
        public static readonly DbAttribute MagicResistance = new ServerMobAttributes(new DbAttribute("MagicResistance", typeof(string), "0", "M. resistance")) { DataConverter = ValueConverters.GetSetZeroString, Description = "The magic resistance of the mob." };
        public static readonly DbAttribute GroupId = new ServerMobAttributes(new DbAttribute("GroupId", typeof(string), "0", "Group Id")) { DataConverter = ValueConverters.GetSetZeroString, Description = "Mob group ID." };
        public static readonly DbAttribute Title = new ServerMobAttributes(new DbAttribute("Title", typeof(string), "0", "Title")) { DataConverter = ValueConverters.GetSetZeroString, Description = "Mob title." };
        public static readonly DbAttribute Ai = new ServerMobAttributes( new DbAttribute("Ai", typeof(string), "", "Ai"));
